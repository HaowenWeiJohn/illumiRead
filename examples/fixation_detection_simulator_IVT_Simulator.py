...
from utils.GazeFilter import GazeDataGapFilling, GazeFilterFixationDetectionIDTAngular, GazeFilterFixationDetectionIVT
...
for index, timestamp in enumerate(timestamps):
    ...
    Gaze_Data_T_classified = ivt_filter.process_sample(Gaze_Data_T)
